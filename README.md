...
* **นาย เมธวิน ปิติสกุลรัตน์ (Project Manager / System Analyst)**
  * *บทบาทหน้าที่*: บริหารจัดการเวลาของโปรเจกต์ วาดแผนภาพโครงสร้างระบบ (Use Case, Class Diagram, Sequence Diagram) รวบรวมความต้องการของระบบ (Requirements) และดูแลขอบเขตการทำงานร่วมกัน
